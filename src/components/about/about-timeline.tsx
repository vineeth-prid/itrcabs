...
const chapters = [
  {
    ...
    text: "ITR Cabs opens its doors in Kochi as a modest single venture — no fleet, no offices, just an uncompromising idea of what service should feel like.",
  },
  {
    icon: HeartHandshake,
    era: "Early years",
  ...
  {
    icon: CarFront,
    era: "Growing the fleet",
    title: "A professional fleet takes shape",
    text: "The first dedicated vehicles arrive — commercially licensed, fully insured, driven by verified professionals. The standards that define ITR Cabs today are written here.",
  },
  {
    icon: Building2,
    era: "Corporate transport",
