...
export interface VehicleSpec {
  ...
  extraKmRate: number;
  driverBata: number;
  /** What the driver is paid for a one-day trip — the customer-facing basePrice minus our margin. */
  driverBasePrice: number;
  /** What the driver is paid per day on a multi-day trip, before bata. */
  driverPerDayPrice: number;
  /** What the driver is paid for each km beyond the included allowance. */
...
export const fleet: VehicleSpec[] = [
  {
    ...
    extraKmRate: 13,
    driverBata: 400,
    driverBasePrice: 1950,
    driverPerDayPrice: 2300,
    driverExtraKmRate: 12,
    illustration: "sedan",
  ...
  },
  {
    ...
    extraKmRate: 15,
    driverBata: 400,
    driverBasePrice: 2500,
    driverPerDayPrice: 2850,
    driverExtraKmRate: 13,
    illustration: "suv",
  ...
  },
  {
    ...
    extraKmRate: 17,
    driverBata: 500,
    driverBasePrice: 2850,
    driverPerDayPrice: 3400,
    driverExtraKmRate: 15,
    illustration: "suv",
  ...
  },
  {
    ...
    extraKmRate: 26,
    driverBata: 600,
    driverBasePrice: 4900,
    driverPerDayPrice: 5800,
    driverExtraKmRate: 23,
  ...
  },
  {
    ...
    extraKmRate: 16,
    driverBata: 450,
    driverBasePrice: 2650,
    driverPerDayPrice: 3200,
    driverExtraKmRate: 14,
    illustration: "mpv",
  ...
  },
  {
    ...
    extraKmRate: 19,
    driverBata: 500,
    driverBasePrice: 3400,
    driverPerDayPrice: 4000,
    driverExtraKmRate: 17,
    illustration: "mpv",
  ...
  },
  {
    ...
    extraKmRate: 28,
    driverBata: 700,
    driverBasePrice: 5800,
    driverPerDayPrice: 6950,
    driverExtraKmRate: 25,
    illustration: "tempo",
  ...
  },
  {
    ...
    extraKmRate: 36,
    driverBata: 800,
    driverBasePrice: 8000,
    driverPerDayPrice: 9350,
    driverExtraKmRate: 32,
    illustration: "tempo",
  ...
  },
  {
    ...
    extraKmRate: 38,
    driverBata: 800,
    driverBasePrice: 8450,
    driverPerDayPrice: 9800,
    driverExtraKmRate: 34,
  ...
  },
  {
    ...
    extraKmRate: 42,
    driverBata: 900,
    driverBasePrice: 9800,
    driverPerDayPrice: 11400,
    driverExtraKmRate: 37,
    illustration: "urbania",
