...
const BookingsManager = dynamicImport(
  () => import("@/components/admin/bookings-manager").then((m) => m.BookingsManager),
  {
    ssr: false,
    loading: () => (
      <p className="py-20 text-center text-sm text-cream/40">Loading bookings…</p>
    ),
  }
);
